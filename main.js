...
const printTodo = function(todo) {
  ...
  // Query the ul and save it in a variable.
...
// or, fancy-like:
// const printTodos = () => todos.forEach((todo) => printTodo(todo))
...
document.querySelector('.remove-completed-todos').addEventListener('click', () => {
